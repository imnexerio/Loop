  ...
  return (
    <div className="min-h-screen">
      ...
      <button
        ...
        className="fixed right-6 bottom-24 w-14 h-14 bg-primary-600 hover:bg-primary-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center z-50"
